...
const (
	...
	index__19 = `" title="list" class="dropdown-item">list<a id="menu_create_entity" class="collapse dropdown-item" href="`
	index__20 = `" title="create">create</a></a></div></li><li class="nav-item dropdown collapse" id="menu_storelocations"><a href="#" title="manage storelocations" class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="mdi mdi-docker mdi-36px iconlabel">`
	index__22 = `" title="list" class="dropdown-item">list<a id="menu_create_storelocation" class="collapse dropdown-item" href="`
	index__23 = `" title="create">create</a></a></div></li><li class="nav-item dropdown collapse" id="menu_people"><a href="#" title="manage people" class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="mdi mdi-account-group mdi-36px iconlabel">`
	index__25 = `" title="list" class="dropdown-item">list<a id="menu_create_person" class="collapse dropdown-item" href="`
	index__26 = `" title="create">create</a></a></div></li><li class="nav-item"><a class="nav-link" title="change password" href="`
	index__27 = `"><span class="mdi mdi-shield-lock-outline mdi-36px iconlabel">`
	index__28 = `</span></a></li><li class="nav-item"><a class="nav-link" title="logout" onclick="localStorage.clear();" href="`
	index__29 = `"><span class="mdi mdi-logout mdi-36px iconlabel">`
	index__30 = `</span></a></li></ul></div></nav><header class="row"><div class="col-sm-12"></div></header></div><!--  Code generated by go generate; DO NOT EDIT. --><script>    
	...
	index__35 = `"></script><script src="`
	index__48 = `"></script></body></html>`
)
