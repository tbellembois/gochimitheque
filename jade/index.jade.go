...
const (
	...
	index__12 = `<li class="nav-item"><a class="nav-link" title="change password" href="`
	index__13 = `"><span class="mdi mdi-shield-lock-outline mdi-36px iconlabel">`
	index__14 = `</span></a></li><li class="nav-item"><a class="nav-link" title="logout" href="`
	index__15 = `"><span class="mdi mdi-logout mdi-36px iconlabel">`
	index__16 = `</span></a></li></ul></div></nav><header class="row"><div class="col-sm-12"></div></header></div><!--  Code generated by go generate; DO NOT EDIT.
 --><script>    
	...
	index__21 = `"></script><script src="`
	index__34 = `"></script></body></html>`
	index__35 = `<li class="nav-item active"><a href="`
	index__36 = `" class="nav-link"><span class="mdi mdi-home mdi-36px iconlabel">`
	index__37 = `</span></a></li>`
	index__39 = `" class="nav-link"><span class="mdi mdi-star mdi-36px iconlabel">`
	index__41 = `<li class="nav-item"><a href="`
	index__42 = `" class="nav-link"><span class="mdi mdi-tag mdi-36px iconlabel">`
	index__44 = `<li class="nav-item dropdown"><a href="#" title="manage entities" class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="mdi mdi-store mdi-36px iconlabel">`
	index__45 = `</span></a><div class="dropdown-menu" aria-labelledby="navbarDropdown"><a href="`
	index__46 = `" title="list" class="dropdown-item">list</a>`
	index__47 = `</div></li>`
	index__48 = `<a href="`
	index__49 = `" title="create" class="dropdown-item">create</a>`
	index__50 = `<li class="nav-item dropdown"><a href="#" title="manage storelocations" class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="mdi mdi-docker mdi-36px iconlabel">`
	index__56 = `<li class="nav-item dropdown"><a href="#" title="manage people" class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="mdi mdi-account-group mdi-36px iconlabel">`
)
