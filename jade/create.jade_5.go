...
const (
	...
	create_5__34 = `</div></div><div class="form-row"><div class="form-group col-sm-auto"><span class="badge badge-pill badge-danger">&nbsp;</span></div><div class="form-group col-sm-5">`
	create_5__36 = `</div><div class="form-group col-sm-1"><button id="fconverter" class="btn btn-link" type="button" data-toggle="popover" data-content="no result" title="convert linear to empirical formula" onclick="linearToEmpirical();"><span class="mdi mdi-rotate-3d mdi-24px"></span></button></div></div><div class="form-row"><div class="form-group col-sm-auto"><span class="badge badge-pill badge-danger">&nbsp;</span></div><div class="form-group col-sm-6">`
	create_5__43 = `</div></div><div class="form-row"><div class="form-group col-sm-5 d-flex align-items-end">`
	create_5__44 = `</div><div class="form-group col-sm-1 d-flex align-items-end"><button id="magical-button" onclick="magic();"><span class="mdi mdi-24px mdi-auto-fix"></span></button></div></div><div class="form-row"><div class="form-group col-sm-6">`
	create_5__53 = `</span></button></form></div><!--  Code generated by go generate; DO NOT EDIT. --><script>    
	...
	create_5__71  = `"></script><script src="../js/chim/product.js"></script></body></html>`
	create_5__173 = `"><span class="`
	create_5__175 = `"></span></label></div>`
)
...
func Productcreate(c ViewContainer, wr io.Writer) {
	...
	buffer.WriteString(create_5__31)
	...
	buffer.WriteString(create_5__34)
	...
	buffer.WriteString(create_5__36)
	...
	buffer.WriteString(create_5__43)
	...
	buffer.WriteString(create_5__44)
...

	{
		...
		WriteEscString(name, buffer)
		buffer.WriteString(create_5__173)
		WriteEscString("mdi mdi-36px "+icon, buffer)
		buffer.WriteString(index_2__66)
		WriteEscString(title, buffer)
		buffer.WriteString(create_5__175)
	...
	buffer.WriteString(create_5__53)
	...
	buffer.WriteString(create_5__71)
