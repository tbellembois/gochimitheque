...
const (
	index_2__30 = `</span></a></li></ul></div></nav><div id="accordion"><div id="list-collapse" class="collapse show" data-parent="#accordion"><header class="row"><div class="col-sm-12"><table id="table" data-toggle="table" data-striped="true" data-search="true" data-side-pagination="server" data-page-list="[10, 20, 50, 100]" data-pagination="true" data-ajax="getData" data-sort-name="entity_name"><thead><tr><th data-field="entity_id">ID</th><th data-field="entity_name" data-sortable="true">`
	index_2__31 = `</th><th data-field="entity_description">`
	index_2__32 = `</th><th data-field="managers" data-formatter="managersFormatter">`
	index_2__33 = `</th><th data-field="operate" data-formatter="operateFormatter" data-events="operateEvents"></th></tr></thead></table></div></header></div><div id="edit-collapse" class="collapse" data-parent="#accordion">`
	index_2__34 = `<form id="entity"><input id="index" type="hidden" name="index" value=""/><input id="entity_id" type="hidden" name="entity_id" value=""/><div class="form-group row">`
	index_2__35 = `</div><div class="form-group row">`
	index_2__37 = `</div></form><button id="save" class="btn btn-link" type="button" onclick="saveEntity()"><span class="mdi mdi-content-save mdi-24px iconlabel">`
	index_2__38 = `</span></button><button class="btn btn-link" type="button" onclick="closeViewEdit();"><span class="mdi mdi-close-box mdi-24px iconlabel">`
	index_2__39 = `</span></button></div></div></div><!--  Code generated by go generate; DO NOT EDIT. --><script>    
	...
	index_2__57 = `"></script><script src="../js/chim/entity.js"></script></body></html>`
	index_2__58 = `<div class="mt-sm-2 mb-sm-2"><div class="row"><div class="col d-flex justify-content-center"><span class="`
	index_2__59 = `"></span></div></div><div class="row"><div class="col d-flex justify-content-center"><span class="`
	index_2__60 = `"></span><span class="iconlabel">`
	index_2__61 = `</span></div></div></div>`
	index_2__62 = `<div class="form-group col-sm-12"><label for="`
	index_2__63 = `">`
	index_2__64 = `</label><input class="form-control" type="text" id="`
	index_2__65 = `" name="`
	index_2__66 = `" title="`
	index_2__67 = `"/></div>`
	index_2__76 = `</label><select class="form-control" style="width: 100% !important;" id="`
	index_2__78 = `" multiple="multiple"></select></div>`
)

func Entityindex(c ViewContainer, wr io.Writer) {
	...
	buffer.WriteString(index_2__30)
	WriteAll(T("entity_name_table_header", 1), true, buffer)
	buffer.WriteString(index_2__31)
	WriteAll(T("entity_description_table_header", 1), true, buffer)
	buffer.WriteString(index_2__32)
	WriteAll(T("entity_manager_table_header", 1), true, buffer)
	buffer.WriteString(index_2__33)
	...
	buffer.WriteString(index_2__34)
	...
	buffer.WriteString(index_2__35)
	...
	buffer.WriteString(index_2__37)
	WriteAll(T("save", 1), true, buffer)
	buffer.WriteString(index_2__38)
	...
	buffer.WriteString(index_2__57)
