...
const (
	index_2__36 = `</span></a></li></ul></div></nav><div id="accordion"><div id="list-collapse" class="collapse show" data-parent="#accordion"><header class="row"><div class="col-sm-12"><table id="table" data-toggle="table" data-striped="true" data-search="true" data-side-pagination="server" data-page-list="[10, 20, 50, 100]" data-pagination="true" data-ajax="getData" data-sort-name="entity_name"><thead><tr><th data-field="entity_id">ID</th><th data-field="entity_name" data-sortable="true">`
	index_2__37 = `</th><th data-field="entity_description">`
	index_2__38 = `</th><th data-field="managers" data-formatter="managersFormatter">`
	index_2__39 = `</th><th data-field="operate" data-formatter="operateFormatter" data-events="operateEvents"></th></tr></thead></table></div></header></div><div id="edit-collapse" class="collapse" data-parent="#accordion">`
	index_2__40 = `<form id="entity"><input id="index" type="hidden" name="index" value=""/><input id="entity_id" type="hidden" name="entity_id" value=""/><div class="form-group row">`
	index_2__41 = `</div><div class="form-group row">`
	index_2__43 = `</div></form><button id="save" class="btn btn-link" type="button" onclick="saveEntity()"><span class="mdi mdi-content-save mdi-24px iconlabel">`
	index_2__44 = `</span></button><button class="btn btn-link" type="button" onclick="closeViewEdit();"><span class="mdi mdi-close-box mdi-24px iconlabel">`
	index_2__45 = `</span></button></div></div></div><!--  Code generated by go generate; DO NOT EDIT. --><script>    
	...
	index_2__63 = `"></script><script src="../js/chim/entity.js"></script></body></html>`
	index_2__64 = `<div class="mt-sm-2 mb-sm-2"><div class="row"><div class="col d-flex justify-content-center"><span class="`
	index_2__65 = `"></span></div></div><div class="row"><div class="col d-flex justify-content-center"><span class="`
	index_2__66 = `"></span><span class="iconlabel">`
	index_2__67 = `</span></div></div></div>`
	index_2__68 = `<div class="form-group col-sm-12"><label for="`
	index_2__69 = `">`
	index_2__70 = `</label><input class="form-control" type="text" id="`
	index_2__71 = `" name="`
	index_2__72 = `" title="`
	index_2__73 = `"/></div>`
	index_2__82 = `</label><select class="form-control" style="width: 100% !important;" id="`
	index_2__84 = `" multiple="multiple"></select></div>`
)
...
func Entityindex(c ViewContainer, wr io.Writer) {
	...
	buffer.WriteString(index_2__36)
	...
	buffer.WriteString(index_2__41)
	...
	buffer.WriteString(index_2__43)
	WriteAll(T("save", 1), true, buffer)
	buffer.WriteString(index_2__44)
