...
const (
	index_2__16 = `</span></a></li></ul></div></nav><div id="accordion"><div id="list-collapse" class="collapse show" data-parent="#accordion"><header class="row"><div class="col-sm-12"><table id="table" data-toggle="table" data-striped="true" data-search="true" data-side-pagination="server" data-page-list="[10, 20, 50, 100]" data-pagination="true" data-ajax="getData" data-sort-name="entity_name"><thead><tr><th data-field="entity_id">ID</th><th data-field="entity_name" data-sortable="true">name</th><th data-field="entity_description">description</th><th data-field="managers" data-formatter="managersFormatter">manager(s)</th><th data-field="operate" data-formatter="operateFormatter" data-events="operateEvents">actions</th></tr></thead></table></div></header></div><div id="edit-collapse" class="collapse" data-parent="#accordion">`
	index_2__17 = `<form id="entity"><input id="index" type="hidden" name="index" value=""/><input id="entity_id" type="hidden" name="entity_id" value=""/><div class="form-group row">`
	index_2__18 = `</div><div class="form-group row">`
	index_2__20 = `</div></form><button id="save" class="btn btn-link" type="button" onclick="saveEntity()"><span class="mdi mdi-content-save mdi-24px iconlabel">`
	index_2__21 = `</span></button><button class="btn btn-link" type="button" onclick="closeViewEdit();"><span class="mdi mdi-close-box mdi-24px iconlabel">`
	index_2__22 = `</span></button></div></div></div><!--  Code generated by go generate; DO NOT EDIT.
 --><script>    
	...
	index_2__40 = `"></script><script src="../js/chim/entity.js"></script></body></html>`
	index_2__68 = `<div class="mt-sm-2 mb-sm-2"><div class="row"><div class="col d-flex justify-content-center"><span class="`
	index_2__69 = `"></span></div></div><div class="row"><div class="col d-flex justify-content-center"><span class="`
	index_2__70 = `"></span><span class="iconlabel">`
	index_2__71 = `</span></div></div></div>`
	index_2__72 = `<div class="form-group col-sm-12"><label for="`
	index_2__73 = `">`
	index_2__74 = `</label><input class="form-control" type="text" id="`
	index_2__75 = `" name="`
	index_2__76 = `" title="`
	index_2__77 = `"/></div>`
	index_2__86 = `</label><select class="form-control" style="width: 100% !important;" id="`
	index_2__88 = `" multiple="multiple"></select></div>`
)
...
func Entityindex(c ViewContainer, wr io.Writer) {
	...
	buffer.WriteString(index_2__16)
	...
	buffer.WriteString(index_2__17)
	...
	buffer.WriteString(index_2__21)
