...
const (
	...
	index_10__40 = `</span></button><button class="btn btn-link" type="button" onclick="closeView();"><span class="mdi mdi-close-box mdi-24px iconlabel">`
	index_10__59 = `"></script><script src="../js/chim/person.js"></script></body></html>`
)
...
func Personindex(c ViewContainer, wr io.Writer) {
	...
	buffer.WriteString(index_10__36)
	...
	buffer.WriteString(index_10__37)
	...
	buffer.WriteString(index_10__40)
