...
func Personindex(c ViewContainer, wr io.Writer) {
	...
	buffer.WriteString(index_10__30)
	...
	buffer.WriteString(index_10__31)
	...
	buffer.WriteString(index_10__33)
	WriteAll(T("save", 1), true, buffer)
	buffer.WriteString(index_10__34)
