...
const (
	create__30 = `</span></a></li></ul></div></nav>`
	create__31 = `<form id="entity"><div class="form-group row">`
	create__35 = `</span></button></div><!--  Code generated by go generate; DO NOT EDIT. --><script>    
