...
const (
	create__36 = `</span></a></li></ul></div></nav>`
	create__37 = `<form id="entity"><div class="form-group row">`
	create__41 = `</span></button></div><!--  Code generated by go generate; DO NOT EDIT. --><script>    
