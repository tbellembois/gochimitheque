...
const (
	test__10 = `" alt="chimitheque_logo" title="Chimithèque"/></div></header><h2>bla</h2><h1>bli</h1><h1>bli</h1></div><!--  Code generated by go generate; DO NOT EDIT. --><script>    
...
func Test(c ViewContainer, wr io.Writer) {
