...
const (
	pupdate__36 = `</span></a></li></ul></div></nav><form id="personp"><div class="row d-flex flex-row justify-content-center"><div><span class="mdi mdi-36px mdi-lock-reset"></span></div></div><div class="form-group row"><div class="col col-sm-4 offset-sm-4">`
	pupdate__37 = `</div></div><div class="form-group row"><div class="col col-sm-4 offset-sm-4">`
	pupdate__38 = `</div></div><div class="row d-flex flex-row justify-content-center"><div><button class="btn btn-link" type="button" onclick="savePersonp()"><span class="mdi mdi-content-save mdi-24px iconlabel">`
	pupdate__39 = `</span></button></div></div></form></div><!--  Code generated by go generate; DO NOT EDIT. --><script>    
	...
	pupdate__60 = `</label><input class="form-control" type="password" id="`
)

func Personpupdate(c ViewContainer, wr io.Writer) {
	...
	buffer.WriteString(pupdate__36)

	{
		...
		buffer.WriteString(pupdate__60)
		WriteEscString(name, buffer)
	...
	buffer.WriteString(pupdate__37)

	{
		var (
			label = "confirm password"
			name  = "person_passwordagain"
		)
	...
	buffer.WriteString(pupdate__38)
	WriteAll(T("save", 1), true, buffer)
	buffer.WriteString(pupdate__39)
