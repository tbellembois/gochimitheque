...
const (
	pupdate__16 = `</span></a></li></ul></div></nav><form id="personp"><div class="row d-flex flex-row justify-content-center"><div><span class="mdi mdi-36px mdi-lock-reset"></span></div></div><div class="form-group row"><div class="col col-sm-4 offset-sm-4">`
	pupdate__17 = `</div></div><div class="form-group row"><div class="col col-sm-4 offset-sm-4">`
	pupdate__18 = `</div></div><div class="row d-flex flex-row justify-content-center"><div><button class="btn btn-link" type="button" onclick="savePersonp()"><span class="mdi mdi-content-save mdi-24px iconlabel">`
	pupdate__19 = `</span></button></div></div></form></div><!--  Code generated by go generate; DO NOT EDIT.
 --><script>    
	...
	pupdate__67 = `</label><input class="form-control" type="password" id="`
)
...
func Personpupdate(c ViewContainer, wr io.Writer) {
	...
	buffer.WriteString(pupdate__16)

	{
		...
		buffer.WriteString(pupdate__67)
		WriteEscString(name, buffer)
	...
	buffer.WriteString(pupdate__17)
	...
	buffer.WriteString(pupdate__18)
	WriteAll(T("save", 1), true, buffer)
	buffer.WriteString(pupdate__19)
