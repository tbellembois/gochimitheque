...
const (
	pupdate__30 = `</span></a></li></ul></div></nav><form id="personp"><div class="row d-flex flex-row justify-content-center"><div><span class="mdi mdi-36px mdi-lock-reset"></span></div></div><div class="form-group row"><div class="col col-sm-4 offset-sm-4">`
	pupdate__31 = `</div></div><div class="form-group row"><div class="col col-sm-4 offset-sm-4">`
	pupdate__32 = `</div></div><div class="row d-flex flex-row justify-content-center"><div><button class="btn btn-link" type="button" onclick="savePersonp()"><span class="mdi mdi-content-save mdi-24px iconlabel">`
	pupdate__33 = `</span></button></div></div></form></div><!--  Code generated by go generate; DO NOT EDIT. --><script>    
	...
	pupdate__54 = `</label><input class="form-control" type="password" id="`
)
...
func Personpupdate(c ViewContainer, wr io.Writer) {
	...
	buffer.WriteString(pupdate__30)

	{
		...
		buffer.WriteString(pupdate__54)
		WriteEscString(name, buffer)
	...
	buffer.WriteString(pupdate__31)
	...
	buffer.WriteString(pupdate__32)
	WriteAll(T("save", 1), true, buffer)
	buffer.WriteString(pupdate__33)
