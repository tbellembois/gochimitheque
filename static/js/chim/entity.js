...
//     var actions = [
//         '<button id="storelocations' + eid + '" eid="' + eid + '" class="storelocations btn btn-link btn-sm" style="display: none;" title="' + gjsUtils.translate("storelocations", container.PersonLanguage) + '" type="button">',
//         '<span class="mdi mdi-docker mdi-24px"><i>' + row.entity_slc + '</i></span>',
//         '</button>',
//         '<button id="members' + eid + '" eid="' + eid + '" class="members btn btn-link btn-sm" style="display: none;" title="' + gjsUtils.translate("members", container.PersonLanguage) + '" type="button">',
//         '<span class="mdi mdi-account-group mdi-24px"><i>' + row.entity_pc + '</i></span>',
//         '</button>',
//         '<button id="edit' + eid + '" eid="' + eid + '" class="edit btn btn-link btn-sm" style="display: none;" title="' + gjsUtils.translate("edit", container.PersonLanguage) + '" type="button">',
//         '<span class="mdi mdi-border-color mdi-24px"></span>',
//         '</button>',
//         '<button id="delete' + eid + '" eid="' + eid + '" class="delete btn btn-link btn-sm" style="display: none;" title="' + gjsUtils.translate("delete", container.PersonLanguage) + '" type="button">',
...
//     //             method: "DELETE",
//     //         }).done(function(data, textStatus, jqXHR) {
//     //             gjsUtils.message(gjsUtils.translate("entity_deleted_message", container.PersonLanguage), "success");
//     //             var $table = $('#table');
...
//         // ask for confirmation and then delete
//         $("button#delete" + row.entity_id).on("click", function () {
//             $.ajax({
//                 url: proxyPath + "entities/" + row['entity_id'],
//                 method: "DELETE",
//             }).done(function (data, textStatus, jqXHR) {
...
//     gjsUtils.message(gjsUtils.translate("entity_created_message", container.PersonLanguage) + ": " + data.entity_name, "success");
...
//     });
//     $table.bootstrapTable('refresh');
//     gjsUtils.message(gjsUtils.translate("entity_updated_message", container.PersonLanguage) + ": " + data.entity_name, "success");
// }
// function saveEntity() {
//     var form = $("#entity");
//     if (!form.valid()) {
