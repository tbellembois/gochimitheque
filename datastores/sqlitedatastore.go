...
func (db *SQLiteDataStore) CreateDatabase() error {
	...
	case 2:
		...
		UPDATE unit SET unit_type="volume" WHERE unit_label="L";
		UPDATE unit SET unit_type="volume" WHERE unit=(SELECT unit_id FROM unit WHERE unit_label="L");
		UPDATE unit SET unit_type="weight" WHERE unit_label="g";
		UPDATE unit SET unit_type="weight" WHERE unit=(SELECT unit_id FROM unit WHERE unit_label="g");
		UPDATE unit SET unit_type="length" WHERE unit_label="m";
		UPDATE unit SET unit_type="length" WHERE unit=(SELECT unit_id FROM unit WHERE unit_label="m");
