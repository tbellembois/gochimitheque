...
func (db *MySQLDataStore) IsProductBookmark(pr Product, pe Person) (bool, error) {
	var (
		sqlr string
		err  error
		i    int
...
func (db *MySQLDataStore) CreateProductBookmark(pr Product, pe Person) error {
	var (
		sqlr string
		err  error
	)
...
func (db *MySQLDataStore) DeleteProductBookmark(pr Product, pe Person) error {
	var (
		sqlr string
		err  error
	)
...
func (db *MySQLDataStore) GetProductsCasNumbers(p helpers.Dbselectparam) ([]CasNumber, int, error) {
	var (
...
func (db *MySQLDataStore) GetProductsCeNumbers(p helpers.Dbselectparam) ([]CeNumber, int, error) {
	var (
		cenumbers                          []CeNumber
		count                              int
		precreq, presreq, comreq, postsreq strings.Builder
...
func (db *MySQLDataStore) GetProductsEmpiricalFormulas(p helpers.Dbselectparam) ([]EmpiricalFormula, int, error) {
	var (
...
func (db *MySQLDataStore) GetProductsLinearFormulas(p helpers.Dbselectparam) ([]LinearFormula, int, error) {
	var (
...
func (db *MySQLDataStore) GetProductsClassOfCompounds(p helpers.Dbselectparam) ([]ClassOfCompound, int, error) {
	var (
...
func (db *MySQLDataStore) GetProductsName(id int) (Name, error) {
...
func (db *MySQLDataStore) GetProductsEmpiricalFormula(id int) (EmpiricalFormula, error) {
...
func (db *MySQLDataStore) GetProductsCasNumber(id int) (CasNumber, error) {
...
func (db *MySQLDataStore) GetProductsSignalWord(id int) (SignalWord, error) {
...
func (db *MySQLDataStore) GetProductsHazardStatement(id int) (HazardStatement, error) {
...
func (db *MySQLDataStore) GetProductsPrecautionaryStatement(id int) (PrecautionaryStatement, error) {
...
func (db *MySQLDataStore) GetProductsSymbol(id int) (Symbol, error) {
...
func (db *MySQLDataStore) GetProductsNames(p helpers.Dbselectparam) ([]Name, int, error) {
	var (
		names                              []Name
		count                              int
		precreq, presreq, comreq, postsreq strings.Builder
...
func (db *MySQLDataStore) GetProductsSymbols(p helpers.Dbselectparam) ([]Symbol, int, error) {
	var (
		symbols                            []Symbol
		count                              int
		precreq, presreq, comreq, postsreq strings.Builder
...
func (db *MySQLDataStore) GetProductsHazardStatementByReference(r string) (HazardStatement, error) {
	var (
		err error
		hs  HazardStatement
	)
...
func (db *MySQLDataStore) GetProductsHazardStatements(p helpers.Dbselectparam) ([]HazardStatement, int, error) {
	var (
...
func (db *MySQLDataStore) GetProductsPrecautionaryStatementByReference(r string) (PrecautionaryStatement, error) {
	var (
		err error
		ps  PrecautionaryStatement
	)
...
func (db *MySQLDataStore) GetProductsPrecautionaryStatements(p helpers.Dbselectparam) ([]PrecautionaryStatement, int, error) {
	var (
...
func (db *MySQLDataStore) GetProductsPhysicalStates(p helpers.Dbselectparam) ([]PhysicalState, int, error) {
	var (
...
func (db *MySQLDataStore) GetProductsSignalWords(p helpers.Dbselectparam) ([]SignalWord, int, error) {
	var (
...
func (db *MySQLDataStore) GetProducts(p helpers.DbselectparamProduct) ([]Product, int, error) {
	var (
		products                                []Product
		count                                   int
...
func (db *MySQLDataStore) GetProduct(id int) (Product, error) {
	var (
		product Product
		sqlr    string
		err     error
...
func (db *MySQLDataStore) DeleteProduct(id int) error {
	var (
		sqlr string
		err  error
	)
...
func (db *MySQLDataStore) CreateProduct(p Product) (error, int) {
	var (
		lastid   int64
		tx       *sql.Tx
		sqlr     string
...
func (db *MySQLDataStore) UpdateProduct(p Product) error {
	var (
		lastid   int64
		tx       *sql.Tx
		sqlr     string
