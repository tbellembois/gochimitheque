...
// MySQLDataStore implements the Datastore interface
...
func NewMySQLDBstore(dataSourceName string) (*MySQLDataStore, error) {
	var (
		db  *sqlx.DB
		err error
	)

	log.WithFields(log.Fields{"dbdriver": "mysql", "dataSourceName": dataSourceName}).Debug("NewDBstore")
...
func (db *MySQLDataStore) InsertSamples() error {
	var (
		c   int
		err error
	)
...
func (db *MySQLDataStore) CreateDatabase() error {
	var (
		err     error
		c       int
		r       *csv.Reader
	...
	CREATE TABLE IF NOT EXISTS person(
		...
		person_password varchar(64) NOT NULL) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;
	...
	CREATE TABLE IF NOT EXISTS entity (
		...
		entity_description varchar(64)) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;
	CREATE UNIQUE INDEX IF NOT EXISTS idx_entity ON entity(entity_id, entity_name);

	CREATE TABLE IF NOT EXISTS storelocation (
		storelocation_id integer PRIMARY KEY AUTO_INCREMENT,
		storelocation_name varchar(64) NOT NULL,
		storelocation_color varchar(64),
		storelocation_canstore boolean default 0,
		storelocation_fullpath varchar(64),
		entity integer NOT NULL,
		storelocation integer,
		FOREIGN KEY(storelocation) references storelocation(storelocation_id),
		FOREIGN KEY(entity) references entity(entity_id)) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;
	...
	CREATE TABLE IF NOT EXISTS supplier (
		...
		supplier_label varchar(64) NOT NULL) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;
	...
	CREATE TABLE IF NOT EXISTS unit (
		...
		unit integer,
		FOREIGN KEY(unit) references unit(unit_id)) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;

	-- person permissions
	CREATE TABLE IF NOT EXISTS permission (
		permission_id integer PRIMARY KEY AUTO_INCREMENT,
		person integer NOT NULL,
		permission_perm_name varchar(64) NOT NULL,
		permission_item_name varchar(64) NOT NULL,
		permission_entity_id integer,
		FOREIGN KEY(person) references person(person_id)) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;
	...
	CREATE TABLE IF NOT EXISTS personentities (
		...
		FOREIGN KEY(personentities_entity_id) references entity(entity_id)) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;
	...
	CREATE TABLE IF NOT EXISTS entitypeople (
		...
		FOREIGN KEY(entitypeople_entity_id) references entity(entity_id)) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;
	CREATE UNIQUE INDEX IF NOT EXISTS idx_entitypeople ON entitypeople(entitypeople_entity_id, entitypeople_person_id);

	-- products symbols
	CREATE TABLE IF NOT EXISTS symbol (
		symbol_id integer PRIMARY KEY AUTO_INCREMENT,
		symbol_label varchar(64) NOT NULL,
		symbol_image varchar(64)) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;

	-- products names
	CREATE TABLE IF NOT EXISTS name (
		name_id integer PRIMARY KEY AUTO_INCREMENT,
		name_label varchar(128) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL UNIQUE) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;
	CREATE UNIQUE INDEX IF NOT EXISTS idx_name ON name(name_label);

	-- products cas numbers
	CREATE TABLE IF NOT EXISTS casnumber (
		casnumber_id integer PRIMARY KEY AUTO_INCREMENT,
		casnumber_label varchar(64) NOT NULL UNIQUE,
		casnumber_cmr varchar(64)) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;
	CREATE UNIQUE INDEX IF NOT EXISTS idx_casnumber ON casnumber(casnumber_label);

	-- products ce numbers
	CREATE TABLE IF NOT EXISTS cenumber (
		cenumber_id integer PRIMARY KEY AUTO_INCREMENT,
		cenumber_label varchar(64) NOT NULL UNIQUE) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;
	...
	CREATE TABLE IF NOT EXISTS empiricalformula (
		empiricalformula_id integer PRIMARY KEY AUTO_INCREMENT,
		empiricalformula_label varchar(64) NOT NULL UNIQUE) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;
	...
	CREATE TABLE IF NOT EXISTS linearformula (
		linearformula_id integer PRIMARY KEY AUTO_INCREMENT,
		linearformula_label varchar(64) NOT NULL UNIQUE) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;
	...
	CREATE TABLE IF NOT EXISTS physicalstate (
		physicalstate_id integer PRIMARY KEY AUTO_INCREMENT,
		physicalstate_label varchar(64) NOT NULL UNIQUE) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;

	-- products signal words
	CREATE TABLE IF NOT EXISTS signalword (
		signalword_id integer PRIMARY KEY AUTO_INCREMENT,
		signalword_label varchar(64) NOT NULL UNIQUE) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;

	-- products classes of compound
	CREATE TABLE IF NOT EXISTS classofcompound (
		classofcompound_id integer PRIMARY KEY AUTO_INCREMENT,
		classofcompound_label varchar(64) NOT NULL UNIQUE) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;
	...
	CREATE TABLE IF NOT EXISTS hazardstatement (
		hazardstatement_id integer PRIMARY KEY AUTO_INCREMENT,
		hazardstatement_label varchar(64) NOT NULL,
		hazardstatement_reference varchar(64) NOT NULL) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;
	CREATE UNIQUE INDEX IF NOT EXISTS idx_hazardstatement ON hazardstatement(hazardstatement_reference, hazardstatement_id);

	-- products precautionary statements
	CREATE TABLE IF NOT EXISTS precautionarystatement (
		precautionarystatement_id integer PRIMARY KEY AUTO_INCREMENT,
		precautionarystatement_label varchar(64) NOT NULL,
		precautionarystatement_reference varchar(64) NOT NULL) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;
	CREATE UNIQUE INDEX IF NOT EXISTS idx_precautionarystatement ON precautionarystatement(precautionarystatement_reference, precautionarystatement_id);

	-- products
	CREATE TABLE IF NOT EXISTS product (
		product_id integer PRIMARY KEY AUTO_INCREMENT,
		product_specificity varchar(64),
		product_msds varchar(64),
		product_restricted boolean default 0,
		product_radioactive boolean default 0,
		product_threedformula varchar(64),
		product_disposalcomment varchar(64),
		product_remark varchar(64),
		product_qrcode varchar(64),
		casnumber integer,
		cenumber integer,
		person integer NOT NULL,
		...
		FOREIGN KEY(name) references name(name_id)) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;
	...
	CREATE TABLE IF NOT EXISTS storage (
		...
		storage_barecode varchar(64),
		storage_comment varchar(64),
		storage_reference varchar(64),
		storage_batchnumber varchar(64),
		...
		FOREIGN KEY(storelocation) references storelocation(storelocation_id)) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;
	...
	CREATE TABLE IF NOT EXISTS borrowing (
		borrowing_id integer PRIMARY KEY AUTO_INCREMENT,
		borrowing_comment varchar(64),
		person integer NOT NULL,
	...
	CREATE TABLE IF NOT EXISTS productsymbols (
		...
		FOREIGN KEY(productsymbols_symbol_id) references symbol(symbol_id)) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;
	...
	CREATE TABLE IF NOT EXISTS productsynonyms (
		...
		FOREIGN KEY(productsynonyms_name_id) references name(name_id)) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;
	...
	CREATE TABLE IF NOT EXISTS producthazardstatements (
		...
		FOREIGN KEY(producthazardstatements_hazardstatement_id) references hazardstatement(hazardstatement_id)) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;
	...
	CREATE TABLE IF NOT EXISTS productprecautionarystatements (
		...
		FOREIGN KEY(productprecautionarystatements_precautionarystatement_id) references precautionarystatement(precautionarystatement_id)) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;
	...
	CREATE TABLE IF NOT EXISTS bookmark (
		...
		product integer NOT NULL,
		FOREIGN KEY(person) references person(person_id),
		FOREIGN KEY(product) references product(product_id)) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;
		
	CREATE TABLE IF NOT EXISTS captcha (
		captcha_id integer PRIMARY KEY AUTO_INCREMENT,
		captcha_token varchar(64) NOT NULL,
		captcha_text varchar(64) NOT NULL) ENGINE=InnoDB AUTO_INCREMENT=1 CHARSET=utf8 ;`
	...
	// tables creation
	log.Debug("creating mysql tables")
	...
	if c == 0 {
		log.Debug("inserting signalwords")
	...
	if c == 0 {
		log.Debug("inserting 0000 casnumber")
	...
	if c == 1 {
		log.Debug("inserting CMR casnumbers")
	...
	if c == 0 {
		log.Debug("inserting hazardstatements")
	...
	if c == 0 {
		log.Debug("inserting precautionarystatement")
	...
	if c == 0 {
		log.Debug("inserting XXX empiricalformula")
	...
	if c == 0 {
		log.Debug("inserting admin person")
...
func (db *MySQLDataStore) Import(dir string) error {
	...
	for {
		...
		log.Debug("oldid: " + oldid + "newsupplier: " + newsupplier)
		// do not import archived cards
		if !newarchive {
			reqValues := "?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?"
			reqArgs := []interface{
