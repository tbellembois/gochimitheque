...
type StoreLocation struct {
	...
	StoreLocationID       NullInt64  `db:"storelocation_id" json:"storelocation_id" schema:"storelocation_id" `
	StoreLocationName     NullString `db:"storelocation_name" json:"storelocation_name" schema:"storelocation_name" `
	StoreLocationCanStore NullBool   `db:"storelocation_canstore" json:"storelocation_canstore" schema:"storelocation_canstore" `
	StoreLocationColor    NullString `db:"storelocation_color" json:"storelocation_color" schema:"storelocation_color" `
